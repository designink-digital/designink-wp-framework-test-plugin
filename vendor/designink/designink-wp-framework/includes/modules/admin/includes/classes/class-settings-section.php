...
use DesignInk\WordPress\Framework\v1_1_0\Admin\Pages\Settings_Field;

if ( ! class_exists( '\DesignInk\WordPress\Framework\v1_1_0\Admin\Pages\Settings_Section', false ) ) {
	...
	final class Settings_Section {
		...
		/** @var \DesignInk\WordPress\Framework\v1_1_0\Admin\Pages Settings Page parent instance */
		protected $Settings_Page;

		/** @var \DesignInk\WordPress\Framework\v1_1_0\Admin\Pages\Settings_Field[] Fields registered to this Section. */
		 ...
		 * 
		 * @return \DesignInk\WordPress\Framework\v1_1_0\Admin\Pages $Settings_Page The Settings Page instance.
		 */
		 ...
		 * 
		 * @return \DesignInk\WordPress\Framework\v1_1_0\Admin\Pages\Settings_Field[] $Settings_Fields The Settings Fields in this Section instance.
		 */
		 ...
		 * 
		 * @param \DesignInk\WordPress\Framework\v1_1_0\Admin\Pages $Settings_Page The parent Settings Page that these settings belong to.
