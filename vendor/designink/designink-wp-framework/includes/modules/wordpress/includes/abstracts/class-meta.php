...
if ( ! class_exists( '\DesignInk\WordPress\Framework\v1_1_0\Meta', false ) ) {
	...
	abstract class Meta {
		...
		/** @var \DesignInk\WordPress\Framework\v1_1_0\Meta_Schema The Schema for the Meta. */
		protected $Schema;
		 ...
		 * 
		 * @return \DesignInk\WordPress\Framework\v1_1_0\Meta_Schema The Meta schema.
		 */
		 ...
		 * 
		 * @param \DesignInk\WordPress\Framework\v1_1_0\Meta_Schema $Schema The Meta Value to use for the schema.
		 */
