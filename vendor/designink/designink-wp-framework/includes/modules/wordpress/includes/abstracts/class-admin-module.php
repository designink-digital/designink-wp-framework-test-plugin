...
if ( ! class_exists( '\DesignInk\WordPress\Framework\v1_1_0\Admin_Module', false ) ) {
			...
			if ( is_dir( $screens_dir ) ) {
				...
				foreach ( $folder_files as $file ) {
					if ( preg_match( '/class-([a-z-]+)\.php/i', $file, $matches ) ) {
						...
						if ( class_exists( $screen_name ) && is_subclass_of( $screen_name, 'DesignInk\WordPress\Framework\v1_1_0\Admin\Screens' ) ) {
