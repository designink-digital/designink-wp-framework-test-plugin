...
if ( ! class_exists( '\DesignInk\WordPress\Framework\v1_1_1\Post_Type', false ) ) {
	...
	abstract class Post_Type extends Singleton {
		...
		/** @var \DesignInk\WordPress\Framework\v1_1_1\Admin\Meta_Box[] A list of Meta Boxes to display for this Post Type. */
		 ...
		 * 
		 * @param \DesignInk\WordPress\Framework\v1_1_1\Admin\Meta_Box
		 */
