...
use DesignInk\WordPress\Framework\v1_1_0\Admin\Meta_Box;
use DesignInk\WordPress\Framework\v1_1_0\Utility;
use DesignInk\WordPress\Framework\v1_1_0\Singleton;

if ( ! class_exists( '\DesignInk\WordPress\Framework\v1_1_0\Post_Type', false ) ) {
	...
	abstract class Post_Type extends Singleton {
		...
		/** @var \DesignInk\WordPress\Framework\v1_1_0\Admin\Meta_Box[] A list of Meta Boxes to display for this Post Type. */
		 ...
		 * 
		 * @param \DesignInk\WordPress\Framework\v1_1_0\Admin\Meta_Box
		 */
