...
if ( ! class_exists( '\DesignInk\WordPress\Framework\v1_1_0\Meta_Schema', false ) ) {
			...
			if ( 'array' === $type ) {
				...
				if ( is_array( $pattern ) ) {
					foreach ( $pattern as $key => $Schema ) {
						// Throw exception if fields aren't type \DesignInk\WordPress\Framework\v1_1_0\Meta_Schema
