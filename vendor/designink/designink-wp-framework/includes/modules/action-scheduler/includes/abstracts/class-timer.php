...
use DesignInk\WordPress\Framework\v1_1_0\Action_Scheduler\Action;
use DesignInk\WordPress\Framework\v1_1_0\Utility;

if ( ! class_exists( '\DesignInk\WordPress\Framework\v1_1_0\Action_Scheduler\Timer', false ) ) {
	...
	abstract class Timer {
		 ...
		 * Get the Actions.
		 * 
		 * @return \DesignInk\WordPress\Framework\v1_1_0\Action_Scheduler\Action[] The Actions.
		 */
		 ...
		 * 
		 * @param \DesignInk\WordPress\Framework\v1_1_0\Action_Scheduler\Action $Action The Action to try and add.
		 ...
		 * 
		 * @return null|\DesignInk\WordPress\Framework\v1_1_0\Action_Scheduler\Action The Action instance or NULL.
		 */
		...
		/**
		 * A wrapper function for \DesignInk\WordPress\Framework\v1_1_0\Action_Scheduler\Timer_Manager::update_timer().
		 * 
		 ...
		 * 
		 * @param \DesignInk\WordPress\Framework\v1_1_0\Action_Scheduler\Timer $Timer The Timer instance to merge Actions from.
		 */
		 ...
		 * 
		 * @return null|\DesignInk\WordPress\Framework\v1_1_0\Action_Scheduler\Timer The timer that was instantiated or FALSE.
		 */
