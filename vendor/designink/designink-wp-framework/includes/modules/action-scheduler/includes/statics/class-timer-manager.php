...
if ( ! class_exists( '\DesignInk\WordPress\Framework\v1_1_0\Action_Scheduler\Timer_Manager', false ) ) {
	...
	final class Timer_Manager {
		 ...
		 * 
		 * @return null|\DesignInk\WordPress\Framework\v1_1_0\Action_Scheduler\Timer The Timer instance or NULL.
		 */
		 ...
		 * 
		 * @param \DesignInk\WordPress\Framework\v1_1_0\Action_Scheduler\Timer $Timer The Timer instance to update.
		 ...
		 * 
		 * @param \DesignInk\WordPress\Framework\v1_1_0\Action_Scheduler\Timer[] The Timers to save.
		 * 
